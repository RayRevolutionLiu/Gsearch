        ...
        try
        {
            ...
            for (int i = 4; i < rowcount; i++)
            {
                ...
                if (IiSheet.GetRow(i).Cells[0].ToString().Trim() != "")
                {
                    ...
                    try
                    {
                        yearMonth = IiSheet.GetRow(i).Cells[3].ToString() + "01";//湊成當年當月的一號
                        ...
                        downloadCount = (int)decimal.Parse(IiSheet.GetRow(i).Cells[2].ToString());
                    }
                    catch (Exception ex)
                    {
                        continue;
                    ...
                    oCmd.Parameters["@main_dbtype"].Value = "SPIE";
