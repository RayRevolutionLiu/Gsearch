...
public class s_Union
{
    ...
    public int Execute(DataTable dt, string strGUID)
    {
        ...
        sb.Append(@"main_parentid,main_dbtype,main_logC,main_downloadC,");
        sb.Append(@"main_email,");
        ...
        try
        {
            ...
            for (int i = 0; i < rowcount; i++)
            {
                ...
                if (dt.Rows[i][0].ToString().Trim() != "" && dt.Rows[i][11].ToString().Trim() != "")
                {
